...
from utils.file_utils import get_log_path,get_log_path_node, get_temp_model_dir, get_best_model_dir, gen_CNL_dir, get_shareEmb_path
...
def get_ciao_emb(args):
    ## 如果数据不存在，则生成数据
    if not os.path.exists('./data/ciao/grpahs.pk'):
